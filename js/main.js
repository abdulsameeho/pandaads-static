...
function headerMenu() {
  $('.js-header-burger').on('click', function () {
    ...
    $('.header-burger js-header-burger').addClass("anime");
    window.headerTimeout = setTimeout(function () {
      $('header-burger js-header-burger').removeClass("anime");
    ...
    $('.js-form').each(function () {
      $(this).validate({
        ...
        submitHandler: function submitHandler(form) {
          $.ajax({
            type: "POST",
            url: "https://script.google.com/macros/s/AKfycbyy7vNdzq_lfPZ1uAUPdqX0CSuagvh54gIwG1zSUsYUp3A2ouL4FYKYWHn6-t7szlyaHg/exec",
            data: $(form).serialize(),
